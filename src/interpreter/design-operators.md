...
- **A function-tiled operator** (`Function`) — evaluate the function across a collection of inputs, essentially vectorising the pointwise definition. Used when the morphism sits downstream of an iteration or data source.
