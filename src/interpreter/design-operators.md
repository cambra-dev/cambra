...
- **`Apply(_, Zip)` with `Tuple` / `Record` arguments** fans the input out to
  ...
  `MapResultToConst` instead. A **store-read arm** (`__store.k`) is a *leaf*
