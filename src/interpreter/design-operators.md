...
complement leg. As the drive advances it rerefinements the consumed source prefix incrementally
...
rerefinements the consumed prefix incrementally as `processed` advances, and releases the source in
